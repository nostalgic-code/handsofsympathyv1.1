  ...
  return (
    <>
      ...
      <div ref={pageRef}>
        ...
        {/* ── MODALITIES ── */}
        <section id="why-modalities" style={{ padding: '0 3.5rem 7rem' }}>
          {MODALITIES.map((m, i) => (
            <div
              key={m.abbr}
              className="mod-item"
            ...
            >
              <div style={{ paddingRight: i % 2 === 0 ? '4rem' : 0, paddingLeft: i % 2 === 1 ? '4rem' : 0, direction: 'ltr' }}>
                <div style={{ fontFamily: 'var(--font-cormorant)', fontSize: '8rem', fontWeight: 300, fontStyle: 'italic', lineHeight: 1, color: 'rgba(127,23,52,0.06)', marginBottom: '0.5rem' }}>
                  {m.index}
                </div>
                <div style={{ fontFamily: 'var(--font-cormorant)', fontSize: '5rem', fontStyle: 'italic', color: m.color, lineHeight: 1 }}>{m.abbr}</div>
              ...
              <div style={{ paddingLeft: i % 2 === 0 ? '4rem' : 0, paddingRight: i % 2 === 1 ? '4rem' : 0, borderLeft: i % 2 === 0 ? '1px solid var(--border)' : undefined, borderRight: i % 2 === 1 ? '1px solid var(--border)' : undefined, direction: 'ltr' }}>
        ...
        {/* ── EVIDENCE ── */}
        <section id="why-evidence" style={{ padding: '6rem 3.5rem', background: 'var(--claret-dark)' }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 mt-16">
            {[
              ...
              <div key={e.num} className="ev-card" style={{ padding: '3rem 2.5rem', borderLeft: i > 0 ? '1px solid rgba(232,216,197,0.1)' : undefined }}>
                <div style={{ fontFamily: 'var(--font-cormorant)', fontSize: '4.5rem', fontWeight: 300, color: 'var(--cream-light)', lineHeight: 1, marginBottom: '0.5rem' }}>
                  {e.num}
                </div>
        ...
        {/* ── PROCESS ── */}
        <section id="why-process" style={{ padding: '6rem 3.5rem', background: 'var(--cream-light)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 mt-16 relative" style={{ position: 'relative' }}>
            {/* Timeline bar */}
            <div style={{ position: 'absolute', top: '0.5rem', left: '2rem', right: '2rem', height: 1, background: 'rgba(127,23,52,0.15)' }} className="hidden md:block" />
            {STEPS.map(s => (
        ...
        {/* ── CTA ── */}
        <section style={{ padding: '7rem 3.5rem', background: 'var(--bg)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
